...
# this list and the one above was generated by ai cause it is general info and time consuming :)
cweTopTen = [
...
incidentTypes = [
    ...
    "Malware",
    "Ransomware",
    "DDoS",# short for distributed denail of service
    "Brute Force",
